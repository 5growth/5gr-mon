...
public interface StorageService {
  ...
  /* - - - - - - - - - - - - - - - - - Scrapper - - - - - - - - - - - - - - - - - */
  String createScrapper(LogScrapperRequestWrapper scrapperRequestWrapper, String id);

  Optional<Scrapper> getScrapper (String scrapperId);

  void updateScrapper(ScrapperWrapper scrapperWrapper);

  void removeScrapper(String topic);
