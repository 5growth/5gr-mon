 ...
 */
public class PrometheusScraperConnector {

    private static final Logger log = LoggerFactory.getLogger(PrometheusScraperConnector.class);

    private String kafka_bootstrap_servers;
    private ConcurrentHashMap<String, PrometheusScraper> concurrentHashMap;

    public PrometheusScraperConnector(
