...
public class KibanaDashboardDescription {
    ...
    private List<DashboardVisualization> visualizations = null;
    ...
    public KibanaDashboardDescription visualizations(List<DashboardVisualization> visualizations) {
        this.visualizations = visualizations;
        return this;
    }

    public KibanaDashboardDescription addVisualizationsItem(DashboardVisualization visualizationsItem) {
