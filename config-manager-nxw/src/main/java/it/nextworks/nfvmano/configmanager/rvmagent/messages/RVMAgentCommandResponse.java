...
public class RVMAgentCommandResponse {
    ...
    public RVMAgentCommandResponse() {
    }

    public RVMAgentCommandResponse(String commandId, String agentId, String errs, String outs, String returncode) {
    ...
    public RVMAgentCommandResponse(KafkaRVMAgentCommandResponse returnKafkaRvmAgentCommandResponse) {
        this.setAgentId(returnKafkaRvmAgentCommandResponse.getAgentId());
        this.setCommandId(returnKafkaRvmAgentCommandResponse.getCommandId());
        this.setErrs(returnKafkaRvmAgentCommandResponse.getErrs());
        this.setOuts(returnKafkaRvmAgentCommandResponse.getOuts());
        this.setReturncode(returnKafkaRvmAgentCommandResponse.getReturncode());
    }
    ...
    public boolean equals(Object o) {
        ...
        RVMAgentCommandResponse that = (RVMAgentCommandResponse) o;
