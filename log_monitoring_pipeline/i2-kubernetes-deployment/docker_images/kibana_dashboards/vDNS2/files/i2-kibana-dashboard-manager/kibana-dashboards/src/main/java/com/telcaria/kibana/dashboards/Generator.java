...
public class Generator {
    ...
    public String createVisualizationObject(KibanaDashboardVisualization visualization) {
        ...
        if(visualization.getMetricNameX_1() != null)
            context.put("metricNameX_1", visualization.getMetricNameX_1());
        if(visualization.getMetricNameX_2() != null)
            context.put("metricNameX_2", visualization.getMetricNameX_2());
        ...
        if(visualization.getYlabel_1() != null)
            context.put("ylabel_1", visualization.getYlabel_2());
        if(visualization.getYlabel_2() != null)
            context.put("ylabel_2", visualization.getYlabel_2());
